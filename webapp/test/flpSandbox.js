		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comvodafonesalesorderlist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comvodafonesalesorderlist-display": {
								"semanticObject": "comvodafonesalesorderlist",
								"action": "display",
								"description": "sales_order_list",
								"title": "sales_order_list",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.vodafone.salesorderlist",
									"url": sap.ui.require.toUrl("com/vodafone/salesorderlist")
								}
							}
						}
					}
